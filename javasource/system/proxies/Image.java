...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Endorse.CustomCoinIcon", mendixObject.getType())) {
			return endorse.proxies.CustomCoinIcon.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Endorse.UserPhoto", mendixObject.getType())) {
